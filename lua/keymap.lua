...
vimkey(
  "<localleader>0",
  "Special Symbol: zero-width spaces",
  "<C-v>u200b",
  { mode = "i" }
)
vimkey(
  "<localleader>)",
  "Chinese Punctuation: （I）",
  "<C-v>uFF08 <C-v>uFF09<C-o>F <c-o>x",
  { mode = "i" }
)
vimkey(
  "<localleader>]",
  "Chinese Punctuation: 「I」",
  "<C-v>u300c <C-v>u300d<C-o>F <c-o>x",
  { mode = "i" }
)
vimkey(
  "<localleader>}",
  "Chinese Punctuation: “I”",
  "<C-v>u201C <C-v>u201D<C-o>F <c-o>x",
  { mode = "i" }
)
vimkey(
  "<localleader>'",
...
vimkey(
  "<leader>ev",
  "Neovim Plugin List",
  "<cmd>edit ~/.config/nvim/lua/plug.lua<cr>"
)
vimkey(
  "<leader>ek",
  "Neovim Keymap",
  "<cmd>edit ~/.config/nvim/lua/keymap.lua<cr>"
)
vimkey(
  "<leader>eo",
  "Neovim Options",
  "<cmd>edit ~/.config/nvim/vim/option.vim<cr>"
)
vimkey("<leader>er", "R Profile", "<cmd>edit ~/.Rprofile<cr>")
vimkey(
  "<leader>es",
  "Stata profile",
  "<cmd>edit ~/.config/stata/profile.do<cr>"
)
...
vimkey(
  "<leader>ed",
  "Flypy Dictionary",
  "<cmd>edit +$ ~/Repositories/ssnhd-rime/配置文件/flypy_top.txt<cr>"
)
...
vimkey("<space><space>V", "New Terminal vertical", function()
  newterm "vertical"
end)
vimkey("<space><space>S", "New Terminal Horizontal", function()
  newterm "horizontal"
end)
vimkey("<space><space>F", "New Terminal Float", function()
  newterm "float"
end)
vimkey("<space><space>T", "New Terminal Tab", function()
  newterm "tab"
end)
